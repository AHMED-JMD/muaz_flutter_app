...
import 'package:muaz_app/models/first_y_model.dart';
...
class First_Year extends StatefulWidget {

  const First_Year({Key? key}) : super(key: key);

  @override
  State<First_Year> createState() => _First_YearState();
}

class _First_YearState extends State<First_Year> {
  ...
  void OrderBook () async {
    ...
    //call api
    String booknum = 'كتاب الصف الاول';
    String kind = 'الصف الاول';
    String price = '20000';
    ...
    return Column(
      children: [
        ...
        GridView.builder(
            ...
            itemCount: lessons_first.length ,
